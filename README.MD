...
- selectFirst: Auto select first option (default: true)
...
```tsx
{
  ...
  selectFirst: true // Auto select first option (default: true)
}

// Disable auto-select first option
{
  field: "city",
  title: "City",
  type: "dropdown",
  ...
  selectFirst: false // Don't auto select first option
}
```
